...
if __name__ == '__main__':
 ...
 #   cmd["cmd-set-parameters"]["evt-version"] = "evt-version-2.0"
  #  cmd["cmd-set-parameters"]["camera-name"] = "remote-camera-avm-front"
    ...
    cmd = {}
    cmd["cmd-set-parameters"]="preview-format-values=preview-format-h264;preview-size-values=1280x800;preview-fps-values=30;receive-ip-address=127.0.0.1;receive-port=8554"
